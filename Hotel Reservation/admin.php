...
$stmt = $conn->prepare("SELECT COUNT(*) FROM reservations WHERE to_date >= :currentDate");
...
<body>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" style="display:inline;">
                            ...
                            <button type="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this reservation?');">Delete</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
    ...
    <div id="editReservationModal" class="modal">
        <div class="modal-content">
            <span class="close" onclick="document.getElementById('editReservationModal').style.display='none'">&times;</span>
