...
<body>
    ...
    <header class="hero-section">
        <div class="container text-center hero-content d-column">
            <h1>WELCOME TO JOSHUA & ROD'S <span class="highlight">HERON'S HAVEN</span></h1>
            <p>Where luxury meets tranquility—Joshua & Rod’s Heron Haven offers a private paradise with stunning pool views and lush tropical gardens.</p>
